    ...
    <div id="list">
     <table>
             ...
             <div id="input">
                 ...
                 <label for="exampleInputEmail1">Send From:</label>
                 <input type="text" class="form-control" name="From_user"/></p>
                 </div>
                 <div class="form-group">
                 <label for="exampleInputEmail1">Send To:</label>
                 <input type="text" class="form-control" name="To_user"/></p>
                 </div>
                 <div class="form-group">
                 <label for="exampleInputEmail1">Credits:</label>
                 <input type="int" class="form-control" name="Credits"/></p>
                 </div>
